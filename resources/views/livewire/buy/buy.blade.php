    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Discover our range of smartphones and gadgets. Choose your device category to explore available phones.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            >
                <div class="relative">
                    ...
                    />
                    <div class="absolute top-2 right-2 bg-blue-100 text-blue-600 text-xs font-semibold px-2 py-1 rounded">
                        Explore
                    </div>
                </div>
                ...
                <div class="p-5 text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Latest deals and top models</p>
                </div>
            </a>
            @endforeach
        </div>
