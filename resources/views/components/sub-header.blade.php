    ...
    >
        <div class="flex flex-col">
            ...
            <nav
                ...
                class="flex flex-wrap gap-4 text-sm md:text-base text-gray-600 dark:text-gray-300 mb-3 md:mb-0"
            >
                <a
                    href="#how-it-works"
        ...
        <div class="w-full md:w-auto">
            <nav
                ...
                class="flex flex-wrap gap-4 text-sm md:text-base text-gray-600 dark:text-gray-300"
            >
                <a
